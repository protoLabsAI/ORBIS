...
# --- Extracted routers -------------------------------------------------------
# Included at module bottom so each router's `from app import …` sees every
# name defined above. Routers read app-level mutable/monkeypatched state as
# ``app.<name>`` at call time; see server/routers/*.py. (#app.py-decomposition)
from server.routers import system as _system_routes  # noqa: E402
